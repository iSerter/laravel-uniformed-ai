...
class ServiceCatalog
{
    ...
    public const MAP = [
        'chat' => [
            'openai' => ['gpt-5', 'gpt-5-mini', 'gpt-5-nano', 'gpt-5-pro', 'gpt-5.2', 'gpt-5.2-pro', 'gpt-4.1-mini','gpt-4.1','gpt-4o-mini','o3-mini', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna'],
            'openrouter' => [
                ...
                'x-ai/grok-4-fast', 'x-ai/grok-4.1-fast', 'x-ai/grok-4', 'x-ai/grok-code-fast-1', 'x-ai/grok-4.5',
                'anthropic/claude-sonnet-4.5', 'anthropic/claude-opus-4.5', 'anthropic/claude-haiku-4.5', 'anthropic/claude-opus-4.1', 'anthropic/claude-opus-4', 'anthropic/claude-sonnet-4', 'anthropic/claude-fable-5',
                'google/gemini-3-pro-preview', 'google/gemini-3-flash-preview', 'google/gemini-2.5-flash', 'google/gemini-2.5-pro', 'google/gemini-3.5-flash',
        ...
        'video' => [
            ...
            'kling' => ['kling-v2-1', 'kling-v2-1-master', 'kling-v2-0', 'kling-v1-6', 'kling-v1-5'],
        ],
    ];
