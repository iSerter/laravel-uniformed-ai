use `composer require openai-php/client` 
...
- [Usage](#usage)
  ...
  - [`Responses` Resource](#responses-resource)
    - [`create`](#create)
    - [`create streamed`](#create-streamed)
    - [`retrieve`](#retrieve-1)
    - [`cancel`](#cancel)
    - [`delete`](#delete-1)
    - [`list`](#list-1)
  ...
  - [`Chat` Resource](#chat-resource)
    - [`create`](#create-5)
    - [`create streamed`](#create-streamed-1)
  - [`Audio` Resource](#audio-resource)
    - [`speech`](#speech)
    - [`speechStreamed`](#speechstreamed)
    - [`transcribe`](#transcribe)
    - [`transcribe streamed`](#transcribe-streamed)
    - [`translate`](#translate)
  ...
  - [`FineTuning` Resource](#finetuning-resource)
    ...
    - [`list job events`](#list-job-events)
  ...
  - [`Vector Stores` Resource](#vector-stores-resource)
    ...
    - [`delete`](#delete-7)
    - [`list`](#list-7)
  - [`Vector Store Files` Resource](#vector-store-files-resource)
    - [`create`](#create-11)
    - [`retrieve`](#retrieve-9)
    - [`delete`](#delete-8)
    - [`list`](#list-8)
    - [`search`](#search)
  - [`Vector Store File Batches` Resource](#vector-store-file-batches-resource)
    - [`create`](#create-12)
  ...
  - [`Completions` Resource (legacy)](#completions-resource-legacy)
    - [`create`](#create-13)
    - [`create streamed`](#create-streamed-2)
  - [`Assistants` Resource (deprecated)](#assistants-resource-deprecated)
    ...
    - [`delete`](#delete-9)
    - [`list`](#list-10)
  - [`Threads` Resource (deprecated)](#threads-resource-deprecated)
    - [`create`](#create-15)
  ...
  - [`Thread Messages` Resource (deprecated)](#thread-messages-resource-deprecated)
    - [`create`](#create-16)
    - [`retrieve`](#retrieve-13)
    - [`modify`](#modify-3)
    - [`delete`](#delete-11)
    - [`list`](#list-11)
  - [`Thread Runs` Resource (deprecated)](#thread-runs-resource-deprecated)
    - [`create`](#create-17)
    - [`create streamed`](#create-streamed-3)
    - [`create streamed with function calls`](#create-streamed-with-function-calls)
    - [`retrieve`](#retrieve-14)
    - [`modify`](#modify-4)
    - [`cancel`](#cancel-3)
    - [`submitToolOutputs`](#submittooloutputs)
    - [`list`](#list-12)
  - [`Thread Run Steps` Resource (deprecated)](#thread-run-steps-resource-deprecated)
  ...
  - [`FineTunes` Resource (deprecated)](#finetunes-resource-deprecated)
    ...
    - [`list events streamed`](#list-events-streamed)
