...
| :--- | :--- | :--- | :--- | :--- |
| **OpenAI** | `gpt-5.6-sol` | $5.00 | $30.00 | Flagship reasoning and long-horizon tasks |
| **OpenAI** | `gpt-5.6-terra` | $2.50 | $15.00 | Mid-tier model for scoped implementation |
| **OpenAI** | `gpt-5.6-luna` | $1.00 | $6.00 | High-volume, cost-efficient model |
...
| **Anthropic** | `claude-fable-5` | $10.00 | $50.00 | Mythos-class flagship model; prompt caching |
...
| **Google** | `gemini-3.5-flash` | $1.50 | $9.00 | Optimized for speed and agentic workflows |
...
| **Google** | `gemini-3.1-flash-lite-image` | $0.25 | $30.00 | Image generation; high cost-efficiency |
| **Google** | `gemini-3.1-flash-image` | $0.50 | $60.00 | Image generation; standard Flash quality |
| **Google** | `gemini-3-pro-image` | $2.00 | $120.00 | Image generation; professional Pro quality |
| **Google** | `gemini-2.5-flash-image` | $0.30 | $30.00 | Image generation; legacy Flash model |
| **DeepSeek** | `deepseek-v3.2` | $0.25 | $0.38 | Extremely competitive pricing |
| **Qwen** | `qwen3-max` | $1.20 / $3.00 | $6.00 / $15.00 | **Tiered:** (≤128k / >128k) |
| **xAI** | `grok-4.5` | $2.00 | $6.00 | High-efficiency model for coding and STEM tasks |
...
*Note: Claude Fable 5, GPT-5.6, Grok 4.5, and Gemini 3.5 Flash pricing as of July 2026. Claude 4.6 / Haiku 4.5 from [Claude API pricing](https://claude.com/pricing#api). GPT 5.4 from [OpenAI API pricing](https://developers.openai.com/api/docs/pricing). Grok 4.20 from [xAI models & pricing](https://docs.x.ai/developers/models). Google Gemini 3.1 from [Gemini API pricing](https://ai.google.dev/gemini-api/docs/pricing#gemini-3.1-pro-preview) (Mar 2026). Google Gemini image models from [Gemini API pricing](https://ai.google.dev/pricing) (July 2026). Other pricing from OpenRouter/Jan 2026. Gemini 3 Pro Preview was deprecated March 9, 2026; use Gemini 3.1 Pro Preview.*
